<script>
  ...
  let fileToUpload = [];
  let touchedTitleInputBox = false;
  let touchedArticleInputBox = false;
  ...
  $: {
    onValueError = touchedArticleInputBox && value == "";
    onTitleError = touchedTitleInputBox && title == "";
  ...
  <form>
    <div class="title">
      ...
      <input
        ...
        on:blur={() => (touchedTitleInputBox = true)}
      />
    </div>
